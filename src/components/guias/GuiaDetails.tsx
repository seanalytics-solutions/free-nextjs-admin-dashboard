...
import { Guia } from "@/actions/guias";
import { useFileViewer } from "@/context/FileViewerContext";

interface GuiaDetailsProps {
  guia: Guia;
}

export default function GuiaDetails({ guia }: GuiaDetailsProps) {
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/3 sm:p-6">
          ...
          <div className="space-y-3">
            {guia.key_pdf && (
              <>
                <button onClick={handleOpenPdf} className="text-blue-600 underline">
                  Ver Documento PDF
                </button>
              </>
            )}
            ...
            <div className="flex justify-between">
              ...
              <Badge
                color={
                  guia.situacion_actual === "entregado" ? "success" : "warning"
                }
              >
            ...
            <div className="flex justify-between">
              ...
              <span className="font-medium text-gray-800 dark:text-white/90">
                {new Date(guia.fecha_creacion).toLocaleString()}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-500 dark:text-gray-400">
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col gap-1">
                ...
                <span className="font-medium text-gray-800 dark:text-white/90 text-sm">
                  {guia.remitente.calle} {guia.remitente.numero},{" "}
                  {guia.remitente.asentamiento}, {guia.remitente.localidad},{" "}
                  {guia.remitente.estado}, {guia.remitente.codigo_postal}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/3 sm:p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col gap-1">
                ...
                <span className="font-medium text-gray-800 dark:text-white/90 text-sm">
                  {guia.destinatario.calle} {guia.destinatario.numero},{" "}
                  {guia.destinatario.asentamiento}, {guia.destinatario.localidad},{" "}
                  {guia.destinatario.estado}, {guia.destinatario.codigo_postal}
                </span>
              </div>
            </div>
          </div>
